	  ...
	  return _temp = _class = function (_Component) {
	    ...
	    _createClass(_class, [{
	      ...
	      value: function render() {
	        ...
	        return _react2.default.createElement('div', { className: 'x-select', onBlur: this.hide }, _react2.default.createElement(SelectComponent, _extends({ multiple: multiple, onHide: this.hide }, this.props, { isActive: this.state.isShow, selectedItem: selectedItem, onClick: this.onClick, ref: function ref(_ref) {
	    ...
	    _createClass(SelectInput, [{
	        ...
	        value: function formatSelected() {
	            ...
	            if (selectedItem.length == 0) {
	                return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'x-selected-item' }, placeholder), _react2.default.createElement('input', { type: 'hidden', ref: function ref(_ref) {
	                ...
	                var arr = selectedItem.map(function (item) {
	                    ...
	                    return _react2.default.createElement('div', { title: item.text, className: 'x-selected-item', key: item.value }, item.text);
	                });
	                if (!multiple) {
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement('div', { className: 'x-select-handle', style: { width: width }, onClick: this.onClick }, this.formatSelected(), _react2.default.createElement('i', { className: !this.state.isExtends ? "xui icon-arrowdown x-arrow" : "xui icon-arrowup x-arrow" }));
	        }
	    }]);
